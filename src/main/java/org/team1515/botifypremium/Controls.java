...
public class Controls {
    ...
    public static final Button EXPAND_VERTICAL_R = new Button(OI.mainStick::getYButton);
    public static final Button RETRACT_VERTICAL_R = new Button(OI.mainStick::getBButton);
