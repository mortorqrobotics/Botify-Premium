...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_drivetrain.setDefaultCommand(new DefaultDriveCommand(
            m_drivetrain,
            () -> -modifyAxis(m_controller.getY()) * Drivetrain.MAX_VELOCITY_METERS_PER_SECOND,
            () -> -modifyAxis(m_controller.getX()) * Drivetrain.MAX_VELOCITY_METERS_PER_SECOND,
            () -> -modifyAxis(m_controller.getX()) * Drivetrain.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND
    ));
